...
import { unit27Quiz1, unit27Quiz2, unit27Quiz3, unit27Quiz4, unit28Quiz1, unit28Quiz2, unit28Quiz3, unit28Quiz4 } from "./questions-unit27-30";
...
function generateQuiz(unitId: number, quizIndex: number, topic: string): Question[] {
    const topics: { [key: number]: { words: string[][], sentences: string[] } } = {
        ...
        // A2 Üniteleri (21-40) - Her biri 8 kelime
        21: { words: [["Ayer", "Dün"], ["Hablé", "Konuştum"], ["Comí", "Yedim"], ["Estudié", "Çalıştım"], ["Trabajé", "Çalıştım"], ["Viajé", "Seyahat ettim"], ["Compré", "Satın aldım"], ["Llegué", "Vardım"]], sentences: ["___ al cine.", "___ con mi amigo.", "___ mucho.", "___ tarde."] },
        22: { words: [["Fui", "Gittim"], ["Hice", "Yaptım"], ["Tuve", "Sahiptim"], ["Estuve", "Bulundum"], ["Vine", "Geldim"], ["Dije", "Dedim"], ["Pude", "Yapabildim"], ["Supe", "Öğrendim"]], sentences: ["___ a España.", "___ mis deberes.", "___ suerte.", "___ la verdad."] },
        23: { words: [["Menú", "Menü"], ["Camarero", "Garson"], ["Cuenta", "Hesap"], ["Propina", "Bahşiş"], ["Plato", "Tabak"], ["Postre", "Tatlı"], ["Reserva", "Rezervasyon"], ["Mesa", "Masa"]], sentences: ["Quiero el ___.", "El ___ es amable.", "La ___ por favor.", "Dejo ___."] },
        24: { words: [["Precio", "Fiyat"], ["Descuento", "İndirim"], ["Talla", "Beden"], ["Probador", "Giyinme kabini"], ["Oferta", "Teklif"], ["Rebaja", "İndirim"], ["Efectivo", "Nakit"], ["Tarjeta", "Kart"]], sentences: ["¿Cuál es el ___?", "Hay ___.", "¿Qué ___ es?", "Pago con ___."] },
        25: { words: [["Billete", "Bilet"], ["Maleta", "Bavul"], ["Pasaporte", "Pasaport"], ["Vacaciones", "Tatil"], ["Reserva", "Rezervasyon"], ["Destino", "Varış yeri"], ["Ida", "Gidiş"], ["Vuelta", "Dönüş"]], sentences: ["Necesito un ___.", "Mi ___ es grande.", "¿Tienes el ___?", "Estoy de ___."] },
        26: { words: [["Habitación", "Oda"], ["Recepción", "Resepsiyon"], ["Llave", "Anahtar"], ["Piscina", "Havuz"], ["Desayuno", "Kahvaltı"], ["Servicio", "Servis"], ["Suite", "Suit"], ["Ascensor", "Asansör"]], sentences: ["Quiero una ___.", "Voy a la ___.", "¿Dónde está la ___?", "El ___ incluido."] },
        27: { words: [["Vuelo", "Uçuş"], ["Retraso", "Gecikme"], ["Escala", "Aktarma"], ["Embarque", "Biniş"], ["Terminal", "Terminal"], ["Puerta", "Kapı"], ["Equipaje", "Bagaj"], ["Facturar", "Check-in"]], sentences: ["Mi ___ sale.", "Hay un ___.", "Tengo una ___.", "La puerta de ___."] },
        28: { words: [["Síntoma", "Semptom"], ["Fiebre", "Ateş"], ["Dolor", "Ağrı"], ["Receta", "Reçete"], ["Tos", "Öksürük"], ["Mareo", "Baş dönmesi"], ["Alergia", "Alerji"], ["Vacuna", "Aşı"]], sentences: ["Tengo ___.", "Me duele el ___.", "Necesito una ___.", "El ___ es fuerte."] },
        29: { words: [["Farmacia", "Eczane"], ["Jarabe", "Şurup"], ["Pastilla", "Hap"], ["Pomada", "Merhem"], ["Vitamina", "Vitamin"], ["Aspirina", "Aspirin"], ["Antibiótico", "Antibiyotik"], ["Inyección", "Enjeksiyon"]], sentences: ["Voy a la ___.", "Tomo ___.", "Necesito ___.", "¿Tiene ___?"] },
        30: { words: [["Programador", "Programcı"], ["Diseñador", "Tasarımcı"], ["Empresario", "İş adamı"], ["Periodista", "Gazeteci"], ["Arquitecto", "Mimar"], ["Científico", "Bilim insanı"], ["Psicólogo", "Psikolog"], ["Veterinario", "Veteriner"]], sentences: ["Soy ___.", "Trabajo como ___.", "Mi amigo es ___.", "Quiero ser ___."] },
        ...
        // B2 Üniteleri (61-80) - Her biri 8 kelime
        61: { words: [["Haya terminado", "Bitirmiş olsun"], ["Haya llegado", "Gelmiş olsun"], ["Haya dicho", "Söylemiş olsun"], ["Haya hecho", "Yapmış olsun"], ["Haya visto", "Görmüş olsun"], ["Hubiera sabido", "Bilseydim"], ["Hubiera podido", "Yapabilseydim"], ["Perfectamente", "Mükemmel"]], sentences: ["Espero que ___.", "Dudo que ___.", "Es posible que ___.", "Ojalá ___."] },
        62: { words: [["Quisiera", "İsterdim"], ["Pudiera", "Yapabilsem"], ["Tuviera", "Olsaydı"], ["Fuera", "Olsaydı"], ["Supiera", "Bilseydim"], ["Viniera", "Gelseydi"], ["Hiciera", "Yapsaydı"], ["Como si", "Sanki"]], sentences: ["Si ___ ir.", "Ojalá ___ tiempo.", "___ fuera verdad.", "Si ___ lo haría."] },
        63: { words: [["A condición de que", "Şartıyla"], ["Siempre que", "Sürece"], ["A menos que", "Medikçe"], ["En caso de que", "Durumunda"], ["Con tal de que", "Yeter ki"], ["Suponiendo que", "Varsayarsak"], ["Dado que", "Göz önüne alınırsa"], ["Hipótesis", "Varsayım"]], sentences: ["___ vengas.", "___ me ayudes.", "___ llueva.", "___ sea posible."] },
        64: { words: [["Tesis", "Tez"], ["Metodología", "Metodoloji"], ["Bibliografía", "Kaynakça"], ["Cita", "Alıntı"], ["Argumento", "Argüman"], ["Conclusión", "Sonuç"], ["Análisis", "Analiz"], ["Investigación", "Araştırma"]], sentences: ["La ___ es clara.", "El ___ es válido.", "La ___ demuestra.", "Según el ___."] },
        65: { words: [["Inversión", "Yatırım"], ["Acción", "Hisse"], ["Bolsa", "Borsa"], ["Inflación", "Enflasyon"], ["Presupuesto", "Bütçe"], ["Impuesto", "Vergi"], ["Deuda", "Borç"], ["Préstamo", "Kredi"]], sentences: ["La ___ aumentó.", "El ___ es alto.", "La ___ es limitada.", "Hay que pagar el ___."] },
        66: { words: [["Juicio", "Dava"], ["Abogado", "Avukat"], ["Fiscal", "Savcı"], ["Testigo", "Tanık"], ["Sentencia", "Karar"], ["Inocente", "Masum"], ["Culpable", "Suçlu"], ["Tribunal", "Mahkeme"]], sentences: ["El ___ decidirá.", "El ___ testificó.", "La ___ es justa.", "Fue declarado ___."] },
        67: { words: [["Inteligencia artificial", "Yapay zeka"], ["Realidad virtual", "Sanal gerçeklik"], ["Ciberseguridad", "Siber güvenlik"], ["Big data", "Büyük veri"], ["Automatización", "Otomasyon"], ["Robótica", "Robotik"], ["Nanotecnología", "Nanoteknoloji"], ["Biotecnología", "Biyoteknoloji"]], sentences: ["La ___ avanza.", "La ___ es crucial.", "El ___ revoluciona.", "La ___ cambia todo."] },
        68: { words: [["Democracia", "Demokrasi"], ["Dictadura", "Diktatörlük"], ["Derechos humanos", "İnsan hakları"], ["Libertad", "Özgürlük"], ["Manifestación", "Gösteri"], ["Activismo", "Aktivizm"], ["Partido político", "Siyasi parti"], ["Constitución", "Anayasa"]], sentences: ["La ___ es valiosa.", "Los ___ son universales.", "Hubo una ___ pacífica.", "La ___ protege."] },
        69: { words: [["Periodismo", "Gazetecilik"], ["Corresponsal", "Muhabir"], ["Editorial", "Başyazı"], ["Reportaje", "Röportaj"], ["Desinformación", "Dezenformasyon"], ["Censura", "Sansür"], ["Viral", "Viral"], ["Podcast", "Podcast"]], sentences: ["El ___ es importante.", "Hay mucha ___.", "La ___ es inaceptable.", "Se hizo ___."] },
        70: { words: [["Ansiedad", "Kaygı"], ["Depresión", "Depresyon"], ["Terapia", "Terapi"], ["Subconsciente", "Bilinçaltı"], ["Trauma", "Travma"], ["Autoestima", "Özgüven"], ["Inteligencia emocional", "Duygusal zeka"], ["Resiliencia", "Dayanıklılık"]], sentences: ["La ___ es común.", "La ___ ayuda.", "La ___ es importante.", "El ___ puede superarse."] },
        71: { words: [["Ética", "Etik"], ["Moral", "Ahlak"], ["Racionalismo", "Rasyonalizm"], ["Paradigma", "Paradigma"], ["Conciencia", "Bilinç"], ["Libre albedrío", "Özgür irade"], ["Metafísica", "Metafizik"], ["Ontología", "Ontoloji"]], sentences: ["La ___ es fundamental.", "El ___ cambió.", "¿Existe el ___?", "La ___ es abstracta."] },
        72: { words: [["Huella de carbono", "Karbon ayak izi"], ["Emisiones", "Emisyonlar"], ["Biodiversidad", "Biyoçeşitlilik"], ["Ecosistema", "Ekosistem"], ["Sostenibilidad", "Sürdürülebilirlik"], ["Deforestación", "Ormansızlaşma"], ["Extinción", "Yok oluş"], ["Calentamiento global", "Küresel ısınma"]], sentences: ["Hay que reducir la ___.", "La ___ está amenazada.", "El ___ está en peligro.", "La ___ es esencial."] },
        73: { words: [["Patrimonio", "Miras"], ["Vanguardia", "Avangard"], ["Surrealismo", "Sürrealizm"], ["Renacimiento", "Rönesans"], ["Barroco", "Barok"], ["Contemporáneo", "Çağdaş"], ["Abstracción", "Soyutlama"], ["Estética", "Estetik"]], sentences: ["Es ___ de la humanidad.", "El arte de ___ rompe reglas.", "El ___ es fascinante.", "La ___ importa."] },
        74: { words: [["Emprendimiento", "Girişimcilik"], ["Startup", "Startup"], ["Inversores", "Yatırımcılar"], ["Plan de negocios", "İş planı"], ["Flujo de caja", "Nakit akışı"], ["Liderazgo", "Liderlik"], ["Networking", "Ağ kurma"], ["Pitch", "Sunum"]], sentences: ["El ___ está de moda.", "Buscamos ___.", "El ___ es sólido.", "El ___ es clave."] },
        75: { words: [["Civilización", "Uygarlık"], ["Imperio", "İmparatorluk"], ["Conquista", "Fetih"], ["Revolución", "Devrim"], ["Época", "Dönem"], ["Colonización", "Sömürgecilik"], ["Independencia", "Bağımsızlık"], ["Arqueología", "Arkeoloji"]], sentences: ["La ___ maya fue avanzada.", "El ___ cayó.", "Fue una ___ difícil.", "La ___ revela el pasado."] },
        76: { words: [["Diagnóstico", "Teşhis"], ["Pronóstico", "Öngörü"], ["Tratamiento", "Tedavi"], ["Intervención", "Müdahale"], ["Cirugía", "Ameliyat"], ["Rehabilitación", "Rehabilitasyon"], ["Pandemia", "Pandemi"], ["Vacunación", "Aşılama"]], sentences: ["El ___ fue certero.", "El ___ es bueno.", "El ___ funciona.", "La ___ cambió todo."] },
        77: { words: [["Narrativa", "Anlatı"], ["Metáfora", "Metafor"], ["Símil", "Benzetme"], ["Protagonista", "Başkahraman"], ["Antagonista", "Hasım"], ["Trama", "Olay örgüsü"], ["Novela", "Roman"], ["Poesía", "Şiir"]], sentences: ["La ___ es cautivadora.", "Usa ___s poderosas.", "El ___ evoluciona.", "La ___ es compleja."] },
        78: { words: [["Diplomacia", "Diplomasi"], ["Tratado", "Antlaşma"], ["Sanción", "Yaptırım"], ["Alianza", "İttifak"], ["Conflicto", "Çatışma"], ["Negociación", "Müzakere"], ["Embargo", "Ambargo"], ["Refugiado", "Mülteci"]], sentences: ["La ___ es esencial.", "Firmaron un ___.", "Impusieron ___es.", "El ___ escaló."] },
        79: { words: [["Debatir", "Tartışmak"], ["Argumentar", "Savunmak"], ["Refutar", "Çürütmek"], ["Conceder", "Kabul etmek"], ["Matizar", "Nüanslamak"], ["Persuadir", "İkna etmek"], ["Consenso", "Uzlaşı"], ["Postura", "Tutum"]], sentences: ["Vamos a ___.", "Hay que ___.", "Logré ___le.", "Mi ___ es clara."] },
        80: { words: [["Dominio", "Ustalık"], ["Fluidez", "Akıcılık"], ["Matiz", "Nüans"], ["Modismo", "Deyim"], ["Competencia", "Yetkinlik"], ["Nivel avanzado", "İleri seviye"], ["Felicidades", "Tebrikler"], ["B2 completado", "B2 tamamlandı"]], sentences: ["Tu ___ es alta.", "Hablas con ___.", "Entiendes los ___es.", "¡___! Terminaste B2."] },
    };
...
const unitTopics: { [key: number]: string } = {
    ...
    21: "Duygular", 22: "Okul/Sınıf", 23: "Meyveler/Sebzeler", 24: "Ülkeler/Milletler", 25: "Fiiller",
    // A2 Üniteleri (26-50)
    26: "Geçmiş Zaman 1", 27: "Geçmiş Zaman 2", 28: "Restoran", 29: "Alışveriş", 30: "Seyahat",
    31: "Otel", 32: "Havalimanı", 33: "Doktor", 34: "Eczane", 35: "Meslekler 2",
    36: "İş Görüşmesi", 37: "Telefon", 38: "E-posta", 39: "Duygular 2", 40: "Karakter",
    41: "Spor", 42: "Müzik/Sanat", 43: "Sinema", 44: "Teknoloji", 45: "Sosyal Medya",
    46: "Gelecek Zaman", 47: "Günlük İfadeler", 48: "Alışkanlıklar", 49: "Sağlık", 50: "A2 Tekrar",
    // B1 Üniteleri (51-75)
    51: "Gelecek Zaman İleri", 52: "Emir Kipi", 53: "Subjuntivo Giriş", 54: "Şart Cümleleri", 55: "Dolaylı Anlatım",
    56: "Çevre/Doğa", 57: "Por vs Para", 58: "Eğitim/Okul", 59: "Teknoloji İleri", 60: "Medya/Haberler",
    61: "Sağlık İleri", 62: "İlişkiler", 63: "Sanat/Kültür", 64: "Politika", 65: "Deyimler",
    66: "Geçmiş Zaman İleri", 67: "İş Dünyası", 68: "Seyahat İleri", 69: "Toplum", 70: "Yazma",
    71: "İleri Yazma", 72: "İleri Konuşma", 73: "Fiil Zamanları", 74: "Edebiyat Giriş", 75: "B1 Tekrar",
    // B2 Üniteleri (76-100)
    76: "Subjuntivo Perfecto", 77: "Subjuntivo Imperfecto", 78: "Şart Cümleleri İleri", 79: "Akademik Yazım", 80: "Ekonomi/Finans",
    81: "Hukuk/Adalet", 82: "Bilim/Teknoloji İleri", 83: "Siyaset/Toplum", 84: "Medya/İletişim", 85: "Psikoloji",
    86: "Felsefe", 87: "Çevre/Sürdürülebilirlik", 88: "Kültür/Sanat İleri", 89: "İş Dünyası İleri", 90: "Tarih/Uygarlıklar",
    91: "Tıp/Sağlık İleri", 92: "Edebiyat", 93: "Uluslararası İlişkiler", 94: "Tartışma", 95: "Retorik",
    96: "Dilbilgisi İleri", 97: "Çeviri", 98: "Akademik Okuma", 99: "Profesyonel İspanyolca", 100: "B2 Tekrar"
};
