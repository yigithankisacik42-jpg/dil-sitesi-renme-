...
const unit41Lecture: UnitLecture = {
    ...
    slides: [
        { id: 1, type: "intro", title: "B1'e Hoş Geldin! 🎉", content: "B1 seviyesi orta seviyedir. Bu ünitede İspanyolca'nın gelecek zamanını (Futuro Simple) öğreneceksin. Gelecek planlarından, tahminlerden ve olasılıklardan bahsetmek için kullanılır.", tip: "İspanyolca'da gelecek zaman çok basit - sadece mastar formun sonuna ekler eklenir!" },
        {
            id: 2, type: "grammar", title: "Düzenli Fiil Çekimi 📝", rules: [
                { rule: "Formül", explanation: "Mastar (hablar, comer, vivir) + ekler. Tüm fiil türleri aynı ekleri alır!", examples: [] }
            ], points: [
                "Yo habl**aré** (Konuşacağım)",
                "Tú habl**arás** (Konuşacaksın)",
                "Él/Ella habl**ará** (Konuşacak)",
                "Nosotros habl**aremos** (Konuşacağız)",
                "Vosotros habl**aréis** (Konuşacaksınız)",
                "Ellos habl**arán** (Konuşacaklar)"
            ]
        },
        { id: 3, type: "example", title: "Örnek Cümleler", content: "Gelecek zaman günlük hayatta:", points: ["Mañana iré al médico. (Yarın doktora gideceğim)", "La semana que viene estudiaré más. (Gelecek hafta daha çok çalışacağım)", "Pronto terminaré el proyecto. (Yakında projeyi bitireceğim)"] },
        { id: 4, type: "summary", title: "Özet 📝", points: ["Ekler: -é, -ás, -á, -emos, -éis, -án", "Tüm fiil türleri (-AR, -ER, -IR) aynı ekleri alır", "Mastar formun sonuna eklenir"] }
    ]
};
...
// Ünite ID'sine göre B1 lecture getir
export function getB1LectureForUnit(unitId: number): UnitLecture {
    const lectures: { [key: number]: UnitLecture } = {
        41: unit41Lecture, 42: unit42Lecture, 43: unit43Lecture, 44: unit44Lecture, 45: unit45Lecture,
        46: unit46Lecture, 47: unit47Lecture, 48: unit48Lecture, 49: unit49Lecture, 50: unit50Lecture,
        51: unit51Lecture, 52: unit52Lecture, 53: unit53Lecture, 54: unit54Lecture, 55: unit55Lecture,
        56: unit56Lecture, 57: unit57Lecture, 58: unit58Lecture, 59: unit59Lecture, 60: unit60Lecture
    };
    return lectures[unitId] || unit41Lecture;
}
