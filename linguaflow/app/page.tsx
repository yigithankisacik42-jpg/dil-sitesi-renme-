        ...
        <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-violet-50 flex flex-col">
            ...
            <header className="h-20 w-full border-b border-slate-200/50 px-4 lg:px-10 flex items-center justify-between bg-white/80 backdrop-blur-md sticky top-0 z-50">
                <div className="flex items-center gap-2">
                    <div className="bg-gradient-to-br from-indigo-600 to-violet-600 rounded-xl p-1.5 shadow-lg shadow-indigo-200">
                    ...
                    {/* Early Access Badge */}
                    {isEarlyAccess && (
                        <span className="ml-2 bg-gradient-to-r from-amber-100 to-orange-100 text-amber-700 text-xs font-bold px-2 py-1 rounded-lg border border-amber-200">
                            🚀 Erken Erişim
                        </span>
                    )}
                </div>
            ...
            <main className="flex-1 flex flex-col lg:flex-row items-center justify-center p-4 gap-10 max-w-[1000px] mx-auto w-full">
                ...
                <div className="relative w-[300px] h-[300px] lg:w-[400px] lg:h-[400px] flex items-center justify-center">
                    <div className="absolute inset-0 bg-gradient-to-br from-indigo-200 to-violet-200 rounded-full animate-pulse opacity-40"></div>
                    <div className="z-10 bg-white border-2 border-slate-100 p-8 rounded-3xl shadow-2xl shadow-indigo-200/50 rotate-3 transition-transform hover:rotate-0 duration-500">
                        <Globe className="w-32 h-32 text-indigo-600" />
                        <div className="absolute -top-4 -right-4 bg-gradient-to-r from-amber-400 to-orange-400 text-white font-bold px-4 py-2 rounded-2xl rotate-12 shadow-lg">
