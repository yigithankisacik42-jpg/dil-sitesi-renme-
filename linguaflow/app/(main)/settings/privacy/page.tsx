...
export default function PrivacyPage() {
    ...
    useEffect(() => {
        const saved = localStorage.getItem("linguaflow_privacy");
        if (saved) {
    ...
    const handleSave = () => {
        ...
        setTimeout(() => {
            localStorage.setItem("linguaflow_privacy", JSON.stringify(settings));
            setSaveStatus("saved");
    ...
    const handleDownloadData = () => {
        const userData = {
            user: JSON.parse(localStorage.getItem("linguaflow_user") || "{}"),
            notifications: JSON.parse(localStorage.getItem("linguaflow_notifications") || "{}"),
            privacy: settings,
            progress: JSON.parse(localStorage.getItem("linguaflow_progress") || "{}"),
